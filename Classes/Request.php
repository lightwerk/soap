 ...
 * A SOAP request
 */
class Request extends \TYPO3\CMS\Extbase\Http\Request {
	 ...
	 *
	 * @var \TYPO3\CMS\Extbase\Http\Uri
	 */
	protected $baseUri;
	 ...
	 * Sets the base URI
	 *
	 * @param \TYPO3\CMS\Extbase\Http\Uri $baseUri
	 * @return void
	 */
	public function setBaseUri(\TYPO3\CMS\Extbase\Http\Uri $baseUri) {
	 ...
	 *
	 * @return \TYPO3\CMS\Extbase\Http\Uri URI of this web request
	 */
	 ...
	 * Sets the WSDL URI
	 *
	 * @param \TYPO3\CMS\Extbase\Http\Uri $wsdlUri
	 * @return void
	 */
	public function setWsdlUri(\TYPO3\CMS\Extbase\Http\Uri $wsdlUri) {
	 ...
	 *
	 * @return \TYPO3\CMS\Extbase\Http\Uri URI pointing to the WSDL
	 */
