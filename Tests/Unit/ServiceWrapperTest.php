 ...
 */
class ServiceWrapperTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	...
	/**
	 * @var \TYPO3\CMS\Soap\ServiceWrapper
	 */
	...
	public function setUp() {
		...
		$this->mockRequest = $this->getMock('TYPO3\CMS\Soap\Request', array(), array(), '', FALSE);
		...
		$this->serviceWrapper = $this->getMock('TYPO3\CMS\Soap\ServiceWrapper', array('initializeCall', 'convertStdClassToObject'), array($this->mockService));
